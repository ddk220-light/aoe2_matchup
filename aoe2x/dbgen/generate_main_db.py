...
def build_combat_dict_from_ref(rc, row):
    ...
    return {
        ...
        "hp_regen_in_combat": special.get("hp_regen_in_combat", 0),
        "food_per_kill": special.get("food_per_kill", 0),
        "wood_per_kill": special.get("wood_per_kill", 0),
        "gold_per_kill": special.get("gold_per_kill", 0),
        ...
        "pass_through_count": int(special.get("pass_through_count", 1)),
        "extra_proj_scatter": int(special.get("extra_proj_scatter", 0)),
        "miss_damage_percent": special.get("miss_damage_percent", 0),
        "hp_per_kill": int(special.get("hp_per_kill", 0)),
        "hp_per_kill_max": int(special.get("hp_per_kill_max", 0)),
        ...
        # Nearby-ally bonuses (Shu Coiled Serpent Array, Georgian Monaspa)
            ...
            if ref_id is not None:
                ...
                cursor.execute(
                    ...
                    (
                        ...
                        combat["hp_regen"],
                        combat["hp_regen_in_combat"],
                        combat["food_per_kill"],
                        combat["wood_per_kill"],
                        combat["gold_per_kill"],
                        combat["pass_through_percent"],
                        combat["pass_through_count"],
                        combat["extra_proj_scatter"],
                        combat["miss_damage_percent"],
                        combat["hp_per_kill"],
                        combat["hp_per_kill_max"],
                        combat["hp_transform_threshold"],
                        combat["pop_space"],
                        combat["armor_strip_per_hit"],
                        combat["charge_attack_melee"],
                        combat["charge_recharge_time"],
                        combat["attack_bonus_nearby"],
                        combat["nearby_bonus_count"],
