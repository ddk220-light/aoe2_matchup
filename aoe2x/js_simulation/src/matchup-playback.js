...
const MATCHUPS = Object.freeze({
  ...
  champion_vs_steppe: Object.freeze({
    truth: "calibration/fixtures/champion_vs_steppe_basics.json",
    mechanics: Object.freeze({
      567: "fixtures/unit_stats/champion_chinese_imperial.json",
      1372: "fixtures/unit_stats/elite_steppe_lancer_cumans_imperial.json",
    }),
  }),
  paladin_vs_steppe: Object.freeze({
    truth: "calibration/fixtures/paladin_vs_steppe_basics.json",
    mechanics: Object.freeze({
      569: "fixtures/unit_stats/paladin_spanish_imperial.json",
      1372: "fixtures/unit_stats/elite_steppe_lancer_cumans_imperial.json",
    }),
  }),
  steppe_vs_elephant: Object.freeze({
    truth: "calibration/fixtures/steppe_vs_elephant_basics.json",
    mechanics: Object.freeze({
      1372: "fixtures/unit_stats/elite_steppe_lancer_cumans_imperial.json",
      1134: "fixtures/unit_stats/elite_battle_elephant_burmese_imperial.json",
    }),
  ...
  scorpion_vs_arbalester: Object.freeze({
    truth: "calibration/fixtures/scorpion_vs_arbalester_basics.json",
    mechanics: Object.freeze({
  ...
  scorpion_vs_paladin: Object.freeze({
    truth: "calibration/fixtures/scorpion_vs_paladin_basics.json",
    mechanics: Object.freeze({
      542: "fixtures/unit_stats/heavy_scorpion_japanese_imperial.json",
      569: "fixtures/unit_stats/paladin_spanish_imperial.json",
    }),
