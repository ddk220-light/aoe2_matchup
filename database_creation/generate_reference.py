...
def generate_reference_database(analyzer):
    ...
    cursor.executescript("""
        CREATE TABLE ref_units (
            ...
            bonus_hp_nearby REAL DEFAULT 0,
            nearby_hp_bonus_count INTEGER DEFAULT 0,
    ...
    def process_unit_audited(
        ...
        cursor.execute(
            """UPDATE ref_units SET
               ...
               bonus_hp_nearby=?, nearby_hp_bonus_count=?,
            ...
            (
                ...
                combat_props.get("bonus_hp_nearby", 0),
                combat_props.get("nearby_hp_bonus_count", 0),
