...
- [Civilization comparison handoff](video-production/CIVILIZATION_COMPARISON_GUIDE.md): entry point for ranking a new unit family and choosing top-10/top-25 highlights. [Recorded rankings and three top-25 lists](video-production/RECORDED_RANKING.md) has the historical formulas, inputs, review decisions, and reproduction commands; [current-policy knight recaptures](video-production/KNIGHT_V2_RECAPTURE.md).
