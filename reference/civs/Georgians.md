...
- Fortified Churches replace Monasteries, and provide +10% work rate to Villagers in a 21-tile square.
...
| Aznauri Cavalry | Mounted units take {{tt|20% |
...
_Full stat comparison: see `reference/units/unique/Monaspa.md`_

## Standard Units Available

Battering Ram, Cavalier, Cavalry Archer, Champion, Crossbowman, Elite Skirmisher, Halberdier, Hand Cannoneer, Heavy Cavalry Archer, Heavy Scorpion, Hussar, Knight, Light Cavalry, Long Swordsman, Mangonel, Pikeman, Scorpion, Siege Onager, Siege Ram, Trebuchet
