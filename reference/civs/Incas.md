...
- Villagers benefit from Blacksmith infantry technologies starting in the [[Castle Age (Age of Empires II).
...
| Fabric Shields | Gives Champi Warriors, Kamayuks, and Slingers +1/{{tt|+1 |
...
_Full stat comparison: see `reference/units/unique/Kamayuk.md`_
