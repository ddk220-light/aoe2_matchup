...
**Strong vs:** Infantry, Villager, camel unit
**Weak vs:** Elite Skirmisher, siege unit, Huskarl, Eagle Warrior, Rattan Archer
...
| Attack | Bracer (+1) |
| Attack | Chemistry (+1) |
| Attack | Curare (deal 5 damage over 15 seconds, Tupi only) |
| Attack | Bogsveigar (+1, Vikings only) |
...
| Armor | Italians (melee=+1, pierce=+1) |
| Armor | Muisca (melee=+2/3 in the Castle/Imperial Age) |
| Creation | Aztecs (+15%) |
