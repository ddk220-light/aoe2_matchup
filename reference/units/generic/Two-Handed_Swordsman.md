...
| Armor | Bagains (melee=+5, Bulgarians only) |
| Speed | Squires (+10%) |
...
| Other | Tuntian (passively generate /min, Wei only) |
...
| HP | Vikings (+20%) |
| Attack | Burmese (+3) |
| Attack | Goths (+3 against Standard Buildings) |
| Attack | Tatars (+20% damage {+50% instead of +25%} from higher elevations) |
| Armor | Malians (pierce=+3) |
