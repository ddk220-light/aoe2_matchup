...
**Strong vs:** Transport Ship, Fishing Ship, building, Galleon, Cannon Galleon
**Weak vs:** Carrack, Demolition Ship, Turtle Ship, Longboat, tower, Castle, siege unit

## Ability

_Can track moving targets naturally_

## Technologies

| Stat | Technology (Effect) |
|------|---------------------|
| Attack | Siphons (deals an explosive charge attack every 25 seconds) |
| Armor | Careening (pierce=+1) |
| Armor | Dry Dock (pierce=+1) |
| Speed | Carvel Hull (+10%) |
| Speed | Clinker Construction (+10%) |
...
| Creation | Shipwright (+54%) |
| Other | Incendiaries (detonates upon death) |
...
| Stat | Civ (Bonus) |
|------|-------------|
| Attack | Tatars (+20% {+50% instead of +25%} from higher elevation) |
| Speed | Berbers (+10%) |
| Creation | Aztecs (+15%) |
| Creation | Persians (+15%/+20% in the Castle/Imperial Age) |
