...
def test_naval_score_attached_to_unit(client):
    """The retained retail Imperial score is served from the hybrid rankings DB."""
    ...
    assert britons.get("naval_effectiveness") == 60.3
    assert britons.get("ranking_score") == 60.3
