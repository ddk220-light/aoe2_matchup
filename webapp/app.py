...
def api_combat_unit(civ_name, unit_slug):
    ...
    cursor.execute(
        ...
        SELECT
            ...
            us.hp_regen, us.pass_through_percent, us.pass_through_count,
            us.extra_proj_scatter, us.miss_damage_percent,
            us.hp_per_kill, us.hp_per_kill_max, us.hp_transform_threshold,
            us.armor_strip_per_hit, us.charge_attack_melee, us.charge_recharge_time,
            us.attack_bonus_nearby, us.nearby_bonus_count,
            us.damage_reflect_percent,
            us.hp_nearby_percent_per_unit, us.hp_nearby_max_units,
    ...
    return jsonify(
        {
            ...
            "hp_per_kill": row["hp_per_kill"] or 0,
            "hp_per_kill_max": row["hp_per_kill_max"] or 0,
